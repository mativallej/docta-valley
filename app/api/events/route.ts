...
const communityEvents: Event[] = [
  {
    ...
    date: '2024-12-03',
    time: '18:30',
    location: 'Bar Lupulus Patio Cervecero, Nueva Córdoba, Córdoba, Argentina',
  ...
  },
  {
    ...
    date: '2025-01-31',
    time: '19:00',
    location: 'Zoom del departamento de Matias Vallejos (Co-Founder de Docta Valley), Barrio General Paz, Córdoba, Argentina',
    modalidad: 'Presencial',
